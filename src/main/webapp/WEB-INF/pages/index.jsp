	...
	<div class="main">
		 <div class="zck">
		  <div class="zc">
			...
			<div class="dl">
				<input  class="dl_img" value="" type="button" onclick="formSubmit('home/fmain.action','_self');"
				  onmouseover="this.style.background='url(${ctx}/statics/skin/default/images/login/dl_h.jpg) no-repeat'" 
				  onmouseout="this.style.background='url(${ctx}/statics/skin/default/images/login/dl_a.jpg) no-repeat'"
				/>
				<input class="reset_img" value="" type="reset"   
				  onmouseover="this.style.background='url(${ctx}/statics/skin/default/images/login/reset_h.jpg) no-repeat'" 
				  onmouseout="this.style.background='url(${ctx}/statics/skin/default/images/login/reset_a.jpg) no-repeat'"
				/>
			</div>
		</div>
